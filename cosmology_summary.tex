...
\newtcolorbox{keybox}[1][]{
  ...
  colback=boxbg,
  colframe=accent,
  leftrule=1pt, toprule=1pt, bottomrule=1pt, rightrule=1pt,
...
% Основний стиль для задачі
\newtcolorbox{problemcontent}[2][]{
    breakable,
    colback = gray!5,
    colframe = blue!50!black,
    coltitle = white,
    title = {\bfseries Задача #2},
    fonttitle = \bfseries,
    sharp corners,
    boxrule = 0.8pt,
    leftrule = 3pt,
...
% Середовище для звичайної задачі
\newenvironment{problem}[1]{
    \refstepcounter{problemcounter}
    \begin{problemcontent}{\theproblemcounter.\ #1}
}{
    \end{problemcontent}
}
...
\part{Чисельні методи і аналіз даних}
\input{chapters/CosmologySoftware.tex}
\input{chapters/PracticalGuide.tex}
