...
% Чётные страницы (слева) — название главы
\fancyhead[LE]{\nouppercase{\leftmark}}


% Нечётные страницы (справа) — название раздела
\fancyhead[RO]{\nouppercase{\rightmark}}

% Номер страницы внизу по центру
\fancyfoot[C]{\thepage}

% Убираем заглавные буквы (чтобы было как в тексте)
...
% Чтобы избежать предупреждения LaTeX
...
\input{chapters/01_inflation_kinematics}
...
%% --------------------------------------------------------
\input{chapters/09_future_research}

%% --------------------------------------------------------
\part{Чисельні методи}
%% --------------------------------------------------------
\input{chapters/10_software}
\input{chapters/11_practical_guide}
